...
class Family:
    ...
    def is_18(self):
        name = int(input("Give me the name of a family member: "))
        if self.members[name]["age"] < 18:
            print(f"Sorry, {self.members[name]['name']} but you're too young")
            return False
        else:
            print(f"Great, {self.members[name]['name']}, let's continue!")
            return True
